const CLIPS = {
  ...
  "11_Kevin": {persona:"Kevin",stage:"information",textures:["frustration","social_stigma"],themes:["social_stigma"],sum:"Kevin gets cinnamon articles, apple cider vinegar advice, and a juice cleanse pamphlet from everyone who hears his news.",keywords:"cinnamon, apple cider vinegar, advice, everyone has a cure, articles, pamphlet"},
  ...
  "17_Kevin": {persona:"Kevin",stage:"first_attempts",textures:["overwhelm","frustration"],themes:["eating"],sum:"Kevin spends forty-five minutes in the cereal aisle reading labels — and when he gives up he buys almond milk he doesn't like.",keywords:"grocery store, cereal aisle, labels, forty-five minutes, almond milk, exhausted"},
  ...
  "25_Kevin": {persona:"Kevin",stage:"setbacks",textures:["frustration","grief"],themes:["medication","work_life"],sum:"Kevin takes a weekend off from testing and eating right four months in. He needs the break. He also feels like garbage.",keywords:"burnout, tired of checking, weekend off, exhausted, needed a break, four months"},
  ...
  "34_Kevin": {persona:"Kevin",stage:"day_to_day",textures:["frustration","grief"],themes:["work_life","eating"],sum:"Kevin's job is client steakhouse dinners. He goes home from one with his numbers so high he sits staring at the meter.",keywords:"client dinner, steakhouse, wine, dessert, work, career, ordered for the table"},
